...
public class RestrictionAdminFilter implements Filter {
    ...
    public void doFilter( ServletRequest req, ServletResponse res, FilterChain chain ) throws IOException,
        ...
        if ( chemin.startsWith( "/css" ) || chemin.startsWith( "/js" ) || chemin.startsWith( "/fonts" ) || chemin.startsWith( "/img" ) ) {
         ...
         */
        if ( ((Utilisateur) session.getAttribute( ATT_SESSION_USER )).getAdmin().equals("non") ) {
